...
global $wpdb;
foreach ( array( 'tra_vel_quote_case_idempotency', 'tra_vel_quote_case_events', 'tra_vel_quote_case_revisions', 'tra_vel_quote_cases', 'tra_vel_agent_approvals', 'tra_vel_agent_events', 'tra_vel_agent_runs', 'tra_vel_agent_limits' ) as $suffix ) {
