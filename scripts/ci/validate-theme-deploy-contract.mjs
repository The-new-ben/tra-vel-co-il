...
if (
  ...
  || releaseRequirements.theme?.version !== '1.37.1'
...
if (!themeStyle.includes('Version: 1.37.1') || !themeStyle.includes('Requires at least: 6.6') || !themeFunctions.includes("define( 'TRA_VEL_V2_VERSION', '1.37.1' )")) {
