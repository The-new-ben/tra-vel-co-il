...
if (
  ...
  || releaseRequirements.theme?.version !== '1.26.0'
...
if (!themeStyle.includes('Version: 1.26.0') || !themeStyle.includes('Requires at least: 6.6') || !themeFunctions.includes("define( 'TRA_VEL_V2_VERSION', '1.26.0' )")) {
