...
<footer class="site-footer">
	<div class="footer-grid page-width">
		...
		<div class="footer-column"><strong><?php esc_html_e( 'מזמינים', 'tra-vel-v2' ); ?></strong><a href="<?php echo esc_url( home_url( '/flights/' ) ); ?>"><?php esc_html_e( 'טיסות', 'tra-vel-v2' ); ?></a><a href="<?php echo esc_url( home_url( '/hotels/' ) ); ?>"><?php esc_html_e( 'מלונות וחבילות', 'tra-vel-v2' ); ?></a><a href="<?php echo esc_url( home_url( '/travel-insurance/' ) ); ?>"><?php esc_html_e( 'ביטוח נסיעות', 'tra-vel-v2' ); ?></a></div>
	...
	<div class="footer-bottom page-width"><span>© <?php echo esc_html( wp_date( 'Y' ) ); ?> Tra-Vel</span><span><?php esc_html_e( 'פרטיות · נגישות · תנאי שימוש', 'tra-vel-v2' ); ?></span></div>
</footer>
