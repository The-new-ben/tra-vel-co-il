...
<footer class="site-footer">
	<div class="footer-grid page-width">
		...
		<div class="footer-column"><strong><?php esc_html_e( 'משווים ובודקים', 'tra-vel-v2' ); ?></strong><a href="<?php echo esc_url( home_url( '/flights/' ) ); ?>"><?php esc_html_e( 'טיסות', 'tra-vel-v2' ); ?></a><a href="<?php echo esc_url( home_url( '/hotels/' ) ); ?>"><?php esc_html_e( 'מלונות', 'tra-vel-v2' ); ?></a><a href="<?php echo esc_url( home_url( '/packages/' ) ); ?>"><?php esc_html_e( 'טיסה + מלון', 'tra-vel-v2' ); ?></a><a href="<?php echo esc_url( home_url( '/travel-insurance/' ) ); ?>"><?php esc_html_e( 'מה חשוב לבדוק בביטוח', 'tra-vel-v2' ); ?></a></div>
