...
class Tra_Vel_V2_Trip_Package_Controller extends WP_REST_Controller {
	...
	public function get_items( $request ) {
		$query = array(
			...
			'direct_only'       => (bool) $request->get_param( 'direct_only' ),
	...
	public function get_collection_params() {
		...
		return array(
			...
			'trip_style'        => array( 'type' => 'string', 'default' => 'city', 'enum' => array( 'city', 'value', 'comfort', 'family', 'romantic' ), 'sanitize_callback' => 'sanitize_key', 'validate_callback' => 'rest_validate_request_arg' ),
			...
			'direct_only'       => array( 'type' => 'boolean', 'default' => true, 'sanitize_callback' => 'rest_sanitize_boolean' ),
