...
<main id="main-content" class="experience-page">
	...
	<?php elseif ( $is_packages ) : ?>
	<section class="section package-composer-section" aria-labelledby="package-results-title"><div class="page-width"><div class="section-heading"><div><span class="eyebrow">Tra-Vel Total Trip</span><h2 id="package-results-title"><?php esc_html_e( 'לא דיל. החלטה שלמה.', 'tra-vel-v2' ); ?></h2><p><?php esc_html_e( 'רואים את המסלול, המלון, הכיסוי, כל התוספות והמחיר לכל ההרכב לפני שבוחרים.', 'tra-vel-v2' ); ?></p></div><p class="package-search-status" data-package-status role="status"><?php esc_html_e( 'מרכיב חלופות...', 'tra-vel-v2' ); ?></p></div><div class="package-trust-alert"><i data-lucide="scan-search"></i><div><strong><?php esc_html_e( 'אין חיסכון בלי בסיס מאומת', 'tra-vel-v2' ); ?></strong><span><?php esc_html_e( 'כל מחיר מוצג כסכום רכיבים. הנחת חבילה תוצג רק כשספק מחובר מספק מחיר נפרד ומחיר משולב בני השוואה.', 'tra-vel-v2' ); ?></span></div></div><div class="package-composer-layout"><div class="package-journey-map" data-package-map aria-label="<?php esc_attr_e( 'מפת חבילת תל אביב לבודפשט', 'tra-vel-v2' ); ?>"><span class="package-map-grid" aria-hidden="true"></span><span class="package-route-line" aria-hidden="true"></span><span class="package-map-point point-origin"><b>TLV</b><small><?php esc_html_e( 'תל אביב', 'tra-vel-v2' ); ?></small></span><span class="package-map-point point-destination"><b>BUD</b><small><?php esc_html_e( 'בודפשט', 'tra-vel-v2' ); ?></small></span><div data-package-map-pins></div><article class="package-map-detail" data-package-map-detail><small><?php esc_html_e( 'החלופה שנבחרה', 'tra-vel-v2' ); ?></small><h3 data-package-map-title><?php esc_html_e( 'מרכיב נסיעה...', 'tra-vel-v2' ); ?></h3><p data-package-map-route></p><div class="package-map-kpis"><span><b data-package-map-total><?php esc_html_e( 'טרם נקבע', 'tra-vel-v2' ); ?></b><?php esc_html_e( 'לכל ההרכב', 'tra-vel-v2' ); ?></span><span><b data-package-map-nights><?php esc_html_e( 'טרם נקבע', 'tra-vel-v2' ); ?></b><?php esc_html_e( 'לילות', 'tra-vel-v2' ); ?></span><span><b data-package-map-score><?php esc_html_e( 'טרם נקבע', 'tra-vel-v2' ); ?></b><?php esc_html_e( 'התאמה', 'tra-vel-v2' ); ?></span></div><button type="button" data-package-map-reset><?php esc_html_e( 'הציגו את הבחירה החכמה', 'tra-vel-v2' ); ?></button></article></div><div class="package-results-grid" data-package-results aria-live="polite"></div></div><div class="package-total-legend"><strong><?php esc_html_e( 'מה נכנס לסכום?', 'tra-vel-v2' ); ?></strong><span><i data-lucide="plane"></i><?php esc_html_e( 'טיסה וכבודה לפי הבחירה', 'tra-vel-v2' ); ?></span><span><i data-lucide="hotel"></i><?php esc_html_e( 'כל הלילות, המסים והעמלות', 'tra-vel-v2' ); ?></span><span><i data-lucide="shield-check"></i><?php esc_html_e( 'ביטוח כהמחשה נפרדת ולא כפוליסה', 'tra-vel-v2' ); ?></span><span><i data-lucide="car-front"></i><?php esc_html_e( 'העברה ותוספות שביקשתם', 'tra-vel-v2' ); ?></span></div></div></section>
	<?php elseif ( $is_insurance ) : ?>
	<section class="section insurance-quote-section" aria-labelledby="insurance-results-title"><div class="page-width"><div class="section-heading"><div><span class="eyebrow">Tra-Vel Coverage Compass</span><h2 id="insurance-results-title"><?php esc_html_e( 'לא רק כמה זה עולה. מה דורש בדיקה.', 'tra-vel-v2' ); ?></h2><p><?php esc_html_e( 'משווים גבולות, השתתפות עצמית, שירות, הרחבות וחריגים לפי היעד והפעילות.', 'tra-vel-v2' ); ?></p></div><p class="insurance-quote-status" data-insurance-status role="status"><?php esc_html_e( 'מכין השוואת כיסויים...', 'tra-vel-v2' ); ?></p></div><div class="insurance-decision-alert"><i data-lucide="shield-alert"></i><div><strong><?php esc_html_e( 'הפוליסה היא המקור הקובע', 'tra-vel-v2' ); ?></strong><span><?php esc_html_e( 'אין כאן הבטחת כיסוי או אישור תביעה. מצב רפואי, הריון ופעילויות מסוימות דורשים בירור, הצהרה ולעיתים חיתום.', 'tra-vel-v2' ); ?></span></div></div><div class="insurance-decision-layout"><div class="insurance-risk-map" data-insurance-risk-map aria-label="<?php esc_attr_e( 'מפת הקשר ביטוחי לנסיעה', 'tra-vel-v2' ); ?>"><span class="insurance-map-continent" aria-hidden="true"></span><span class="insurance-map-label">WORLD</span><div data-insurance-risk-pins></div><article class="insurance-risk-detail"><small><?php esc_html_e( 'הקשר הנסיעה שנבחר', 'tra-vel-v2' ); ?></small><h3 data-insurance-risk-title><?php esc_html_e( 'טוען התאמה...', 'tra-vel-v2' ); ?></h3><p data-insurance-risk-note></p><div data-insurance-risk-addons></div><button type="button" data-insurance-risk-reset><?php esc_html_e( 'חזרה לחופשה עירונית', 'tra-vel-v2' ); ?></button></article></div><div class="insurance-plan-grid" data-insurance-results aria-live="polite"></div></div><div class="insurance-policy-note"><i data-lucide="file-check-2"></i><div><strong data-insurance-policy-title><?php esc_html_e( 'לפני רכישה אמיתית', 'tra-vel-v2' ); ?></strong><span data-insurance-policy-note><?php esc_html_e( 'יש לפתוח את נוסח הפוליסה, דף פרטי הביטוח, רשימת ההרחבות ותהליך התביעה של המבטח.', 'tra-vel-v2' ); ?></span></div></div></div></section>
	<?php endif; ?>
	...
	<section class="section dark experience-map-section"><div class="page-width experience-map-grid"><div><span class="kicker"><i data-lucide="earth"></i>Tra-Vel Globe</span><h2><?php esc_html_e( 'כל אפשרות מקבלת מקום, מחיר והסבר.', 'tra-vel-v2' ); ?></h2><p><?php esc_html_e( 'המפה מחברת את החיפוש למסלול: רואים מה משתנה כשמזיזים תאריך, תקציב, אזור או רמת גמישות.', 'tra-vel-v2' ); ?></p><ul><li><?php esc_html_e( 'מחיר כולל והקשר היסטורי', 'tra-vel-v2' ); ?></li><li><?php esc_html_e( 'זמן, נוחות ורמת סיכון', 'tra-vel-v2' ); ?></li><li><?php esc_html_e( 'הצעה יזומה לצעד הבא', 'tra-vel-v2' ); ?></li></ul><a class="button-link" href="<?php echo esc_url( $map_url ); ?>"><?php echo esc_html( $experience['action'] ); ?><i data-lucide="arrow-left"></i></a></div><div class="experience-globe" aria-label="<?php esc_attr_e( 'מפת החלטות למסע', 'tra-vel-v2' ); ?>"><span class="origin-point"></span><span class="route-curve curve-one"></span><span class="route-curve curve-two"></span><span class="experience-pin pin-one"><?php esc_html_e( 'עיר', 'tra-vel-v2' ); ?></span><span class="experience-pin pin-two"><?php esc_html_e( 'חוף', 'tra-vel-v2' ); ?></span><span class="experience-pin pin-three"><?php esc_html_e( 'טבע', 'tra-vel-v2' ); ?></span><article><small><?php esc_html_e( 'הבחירה החכמה עכשיו', 'tra-vel-v2' ); ?></small><strong><?php echo esc_html( $experience['action'] ); ?></strong><span><?php esc_html_e( 'פתחו חיפוש כדי לאמת מחיר ותנאים', 'tra-vel-v2' ); ?></span></article></div></div></section>
