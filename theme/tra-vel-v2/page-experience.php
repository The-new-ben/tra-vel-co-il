	...
	<section class="experience-hero">
		<div class="page-width experience-hero-grid">
			...
			<form class="experience-search flight-search-form" data-flight-search data-auto-search="<?php echo esc_attr( $flight_initial_search ? 'true' : 'false' ); ?>" data-initial-status="<?php echo esc_attr( sprintf( __( 'שמנו את %s בטופס. החיפוש הזמין כרגע עדיין אינו מכסה מסלול זה, ולכן לא הצגנו מחירים של יעד אחר.', 'tra-vel-v2' ), $flight_destination_name ) ); ?>" aria-label="<?php esc_attr_e( 'חיפוש טיסות', 'tra-vel-v2' ); ?>">
				<div class="flight-airports"><label><?php esc_html_e( 'מאיפה', 'tra-vel-v2' ); ?><input name="origin" value="<?php echo esc_attr( $requested_origin_code ); ?>" maxlength="3" pattern="[A-Za-z]{3}" required><span><?php echo esc_html( $requested_origin_label ); ?></span></label><i data-lucide="arrow-left-right"></i><label><?php esc_html_e( 'לאן', 'tra-vel-v2' ); ?><input name="destination" value="<?php echo esc_attr( $flight_destination_code ); ?>" maxlength="3" pattern="[A-Za-z]{3}" required><span><?php echo esc_html( $flight_destination_name ); ?></span></label></div>
				<div class="flight-date-grid"><label><?php esc_html_e( 'יציאה', 'tra-vel-v2' ); ?><input type="date" name="departure_date" min="<?php echo esc_attr( $today_date ); ?>" value="<?php echo esc_attr( $departure_default ); ?>" required></label><label><?php esc_html_e( 'חזרה', 'tra-vel-v2' ); ?><input type="date" name="return_date" min="<?php echo esc_attr( $date_after( $departure_default, 1 ) ); ?>" value="<?php echo esc_attr( $return_default ); ?>" required></label></div>
			...
			<form class="experience-search hotel-search-form" data-hotel-search data-auto-search="<?php echo esc_attr( $hotel_initial_search ? 'true' : 'false' ); ?>" data-initial-status="<?php echo esc_attr( sprintf( __( 'שמנו את %s בטופס. חיפוש הלינה הזמין כרגע עדיין אינו מכסה יעד זה, ולכן לא הצגנו מלונות מעיר אחרת.', 'tra-vel-v2' ), $stay_destination_name ) ); ?>" aria-label="<?php esc_attr_e( 'חיפוש מלונות', 'tra-vel-v2' ); ?>">
				...
				<div class="hotel-date-grid"><label><?php esc_html_e( 'כניסה', 'tra-vel-v2' ); ?><input type="date" name="checkin" min="<?php echo esc_attr( $today_date ); ?>" value="<?php echo esc_attr( $checkin_default ); ?>" required></label><label><?php esc_html_e( 'יציאה', 'tra-vel-v2' ); ?><input type="date" name="checkout" min="<?php echo esc_attr( $date_after( $checkin_default, 1 ) ); ?>" value="<?php echo esc_attr( $checkout_default ); ?>" required></label></div>
			...
			<form class="experience-search package-search-form" data-package-search data-auto-search="<?php echo esc_attr( $package_initial_search ? 'true' : 'false' ); ?>" data-initial-status="<?php echo esc_attr( sprintf( __( 'שמנו את %s במרכיב החבילה. החיפוש הזמין כרגע עדיין אינו מכסה יעד זה, ולכן לא הצגנו חבילה של עיר אחרת.', 'tra-vel-v2' ), $stay_destination_name ) ); ?>" aria-label="<?php esc_attr_e( 'בניית חבילת נסיעה', 'tra-vel-v2' ); ?>">
				...
				<div class="package-route-row"><label><?php esc_html_e( 'מאיפה', 'tra-vel-v2' ); ?><span><input name="origin" value="<?php echo esc_attr( $requested_origin_code ); ?>" maxlength="3" pattern="[A-Za-z]{3}" required><b><?php echo esc_html( $requested_origin_label ); ?></b></span></label><i data-lucide="arrow-left"></i><label><?php esc_html_e( 'לאן', 'tra-vel-v2' ); ?><span><input name="destination" value="<?php echo esc_attr( $stay_destination_code ); ?>" maxlength="3" pattern="[A-Za-z]{3}" required><b><?php echo esc_html( $stay_destination_name ); ?></b></span></label></div>
				<div class="package-date-grid"><label><?php esc_html_e( 'יציאה', 'tra-vel-v2' ); ?><input type="date" name="departure_date" min="<?php echo esc_attr( $today_date ); ?>" value="<?php echo esc_attr( $package_departure ); ?>" required></label><label><?php esc_html_e( 'חזרה', 'tra-vel-v2' ); ?><input type="date" name="return_date" min="<?php echo esc_attr( $date_after( $package_departure, 1 ) ); ?>" value="<?php echo esc_attr( $package_return ); ?>" required></label></div>
