	...
	<section class="directory-command page-width" id="directory-grid">
		...
		<div class="directory-grid" data-directory-grid>
			<?php foreach ( $destinations as $destination ) :
				...
				?>
				<article class="directory-card" data-directory-card data-directory-destination="<?php echo esc_attr( $destination['id'] ); ?>" data-region="<?php echo esc_attr( $destination['region'] ); ?>" data-experience="<?php echo esc_attr( $destination['experience'] ); ?>" data-search="<?php echo esc_attr( $search_text ); ?>">
