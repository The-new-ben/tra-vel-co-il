...
<header class="site-header <?php echo $overlay_header ? 'overlay' : 'on-light'; ?>">
	<div class="header-inner page-width">
		...
		<div class="mobile-drawer"><a href="<?php echo esc_url( home_url( '/#search' ) ); ?>"><?php esc_html_e( 'טיסות, מלונות וחבילות', 'tra-vel-v2' ); ?></a><a href="<?php echo esc_url( home_url( '/travel-map/' ) ); ?>"><?php esc_html_e( 'מפת המחירים החכמה', 'tra-vel-v2' ); ?></a><a href="<?php echo esc_url( home_url( '/destinations/' ) ); ?>"><?php esc_html_e( 'יעדים ומדריכים', 'tra-vel-v2' ); ?></a><a href="<?php echo esc_url( home_url( '/travel-insurance/' ) ); ?>"><?php esc_html_e( 'ביטוח נסיעות', 'tra-vel-v2' ); ?></a></div>
	</div>
</header>
