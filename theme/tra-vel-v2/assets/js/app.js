...
const destinationData = {
  bangkok: { city: 'בנגקוק, תאילנד', price: '$742', note: 'חיסכון של $157 דרך דובאי', image: `${destinationAssetBase}thailand.jpg`, tags: ['12 לילות', 'עצירה אחת', 'כולל כבודה'] },
  athens: { city: 'אתונה, יוון', price: '$189', note: 'המחיר הנמוך ביותר השבוע', image: `${destinationAssetBase}city-vienna.webp`, tags: ['טיסה ישירה', '3 לילות', 'ביטול גמיש'] },
  budapest: { city: 'בודפשט, הונגריה', price: '$214', note: 'מלון 4★ במרכז כלול', image: `${destinationAssetBase}city-budapest.webp`, tags: ['טיסה + מלון', '4 לילות', 'ארוחת בוקר'] },
  dubai: { city: 'דובאי, איחוד האמירויות', price: '$236', note: 'המחיר ירד ב־11% היום', image: `${destinationAssetBase}hero-budapest-900.webp`, tags: ['טיסה ישירה', 'סופ״ש', 'טרולי כלול'] },
  tokyo: { city: 'טוקיו, יפן', price: '$918', note: 'חלון מחיר טוב לחודש נובמבר', image: `${destinationAssetBase}thailand.jpg`, tags: ['עצירה אחת', '14 לילות', 'כבודה כלולה'] },
  lisbon: { city: 'ליסבון, פורטוגל', price: '$327', note: 'שילוב טיסות חכם דרך רומא', image: `${destinationAssetBase}city-prague.webp`, tags: ['7 לילות', 'עצירה אחת', 'מלון מומלץ'] }
};
